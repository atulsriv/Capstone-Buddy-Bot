...
namespace buddybot_hardware_interface
{
    ...
    class buddybotHardwareInterface : public buddybot_hardware_interface::buddybotHardware
    {
        public:
            buddybotHardwareInterface(ros::NodeHandle& nh);
            ~buddybotHardwareInterface();
            void init();
